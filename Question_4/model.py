...
class NeuralNetwork:
    ...
    def save_weights(self, filename):
        ...
        -----------
        filename : str
            The path to the file where the weights will be saved. The file will be saved in NumPy's .npy format.
        ...
        Notes:
        -------
        The weights and biases of the neural network (W1, b1, W2, b2) are saved in a NumPy array format.
        The saved file can later be used to load the weights back into the model.
        """
        np.save(filename, [self.W1, self.b1, self.W2, self.b2])
    ...
    def load_weights(self, filename):
        ...
        -----------
        filename : str
            The path to the file from which the weights will be loaded. The file should be in NumPy's .npy format.
        ...
        Notes:
        -------
        The weights and biases of the neural network (W1, b1, W2, b2) are loaded from a NumPy array format.
        The loaded weights will be used to restore the model's state.
        """
